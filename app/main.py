...
MACRO_AUTO_REFRESH_INTERVAL_SEC = max(
    60.0,
    float(os.getenv("MACRO_AUTO_REFRESH_INTERVAL_SEC", "600")),
)
...
PUBLIC_MACRO_EVENT_TYPES = [
    ...
    {"event_code": "fed_warsh_speech", "label_zh": "Kevin Warsh 美联储主席讲话", "label_en": "Kevin Warsh Speech", "source": "fed_speeches", "local_timezone": "America/New_York"},
    {"event_code": "fed_jefferson_speech", "label_zh": "Philip Jefferson 美联储副主席讲话", "label_en": "Philip Jefferson Speech", "source": "fed_speeches", "local_timezone": "America/New_York"},
    {"event_code": "fed_bowman_speech", "label_zh": "Michelle Bowman 美联储理事讲话", "label_en": "Michelle Bowman Speech", "source": "fed_speeches", "local_timezone": "America/New_York"},
    {"event_code": "fed_speech", "label_zh": "Jerome Powell 美联储讲话", "label_en": "Jerome Powell Speech", "source": "fed_speeches", "local_timezone": "America/New_York"},
    {"event_code": "fed_waller_speech", "label_zh": "Christopher Waller 美联储理事讲话", "label_en": "Christopher Waller Speech", "source": "fed_speeches", "local_timezone": "America/New_York"},
    {"event_code": "nyfed_williams_speech", "label_zh": "John Williams 纽约联储主席讲话", "label_en": "John Williams Speech", "source": "nyfed_williams_speeches", "local_timezone": "America/New_York"},
    {"event_code": "whitehouse_trump_remarks", "label_zh": "Donald Trump 总统讲话", "label_en": "Donald Trump Remarks", "source": "whitehouse_remarks", "local_timezone": "America/New_York"},
    {"event_code": "state_diplomatic_official_statement", "label_zh": "美国外交官员讲话与声明", "label_en": "U.S. Diplomatic Official Statement", "source": "state_diplomacy", "local_timezone": "America/New_York"},
...
def macro_event_detail(source: str, event_id: str) -> dict[str, Any]:
    ...
    needs_clean_refetch = any(
        marker in article_body
        for marker in ("Skip to main content", "An official website of the United States Government", "Stay Connected")
    )
    if (not article_body or needs_clean_refetch) and article_url:
