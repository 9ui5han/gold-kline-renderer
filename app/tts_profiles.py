...
_DEFAULT_PROFILES: tuple[dict[str, Any], ...] = (
    ...
    {"profile_id": "mm_finance_male_02", "provider": "minimax", "voice_id": "Chinese (Mandarin)_Radio_Host", "display_name": "MiniMax 电台男主播", "language": "zh", "gender": "male", "default_speed": 1.0, "speed_min": 0.90, "speed_max": 1.05, "default_emotion": "calm", "status": "verified", "source": "minimax-system-voice-list"},
    {"profile_id": "mm_finance_male_03", "provider": "minimax", "voice_id": "Chinese (Mandarin)_Reliable_Executive", "display_name": "MiniMax 沉稳高管", "language": "zh", "gender": "male", "default_speed": 1.0, "speed_min": 0.90, "speed_max": 1.05, "default_emotion": "calm", "status": "verified", "source": "minimax-system-voice-list"},
